...
public class CommandLineParameterValidator {
	...
	public static Map<String, String> verifyCommandLineArguments(String[] args) {
		...
		try {
			...
			return collectArguments(sprintissues, id, username, password, commandLine);					
	...
	private static Map<String, String> collectArguments(CLOptions sprintissues, CLOptions id,
			CLOptions username, CLOptions password, final CommandLine commandLine) {
